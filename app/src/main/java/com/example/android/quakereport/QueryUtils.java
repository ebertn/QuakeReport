    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            for(int i = 0; i < features.length(); i++){
                currentJSONObject = features.getJSONObject(i).getJSONObject("properties");
                mag = currentJSONObject.getDouble("mag");
                place = currentJSONObject.getString("place");
                timeInMilliseconds = currentJSONObject.getLong("time");
            ...
            // If an error is thrown when exechuting any of the above statements in the "try" block,
